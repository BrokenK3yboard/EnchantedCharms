...
public class GrapplerEnchantment extends CharmEnchantment {
    ...
    public static final Predicate<ItemStack> GRAPPLING_ENCH = stack -> (EnchantmentHelper.getItemEnchantmentLevel(EnchantedCharms.GRAPPLER.get(), stack) > 0);
    ...
    public void useGrapple(EntityLeaveWorldEvent event) {
